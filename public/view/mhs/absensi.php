					...
					<table>
						...
						<tbody>
							<?php
								...
								FROM jadwal
								INNER JOIN absensi ON jadwal.kode_jadwal = absensi.kode_jadwal
								...
								while ($jadwal = mysqli_fetch_assoc($resultjadwal)) {
									...
									echo "<td style='display: flex; justify-content: end;'>
											<a 
												class='btn btn-outline-primary' href='inputabsen.php?id=" . mysqli_real_escape_string($conn, $jadwal['kode_jadwal']) . "'>Absen
											</a>
										</td>";
									echo "</tr>";
								}
