		...
		<main>
            ...
            <div class="table-data">
				<div class="order">
                    ...
                    <form action="../../../controller/app/admin/tambahdosen.php" method="POST" onsubmit="return validateForm()">
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3-row">
                            <div class="col-sm-12 d-flex justify-content-end">
                                <a href="dosen.php" style="margin-right: 10px;" type="submit" class="btn btn-outline-danger" name="batal">Batal</a>
