            ...
            <div class="table-data">
				<div class="order">
                    ...
                    <?php 
                        ...
                        if(isset($_GET['id'])){
                            $id = $_GET['id'];
                            $mhsquery = "SELECT * FROM mahasiswa WHERE id = '$id'";
                            $mhsresult = mysqli_query($conn, $mhsquery);
                            
                            // Periksa apakah query berhasil dijalankan
                            if($mhsresult && mysqli_num_rows($mhsresult) > 0) {
                                $mhs = mysqli_fetch_assoc($mhsresult);
                            } 
                        }
                    ?>

                    <form action="../../../controller/app/admin/updatemhs.php?id=<?php echo $id ?>" method="POST">
                        <div class="mb-3 row">
                            <label class="col-sm-2 col-form-label">NIM</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control-plaintext" value="<?php echo $mhs['nim'] ?>" name="nim">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <input type="number"  class="form-control" value="<?php echo $mhs['phone'] ?>" name="no">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-select" aria-label="Default select example" name="prodi">
                                    <option><?php echo $mhs['kode_prodi'] ?></option>
                                    <?php 
                        ...
                        <div class="mb-3-row">
                            <div class="col-sm-12 d-flex justify-content-end">
                                <a href="mahasiswa.php" style="margin-right: 10px;" class="btn btn-outline-danger" name="batal">Batal</a>
