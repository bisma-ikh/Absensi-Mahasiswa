            ...
            <div class="table-data">
				<div class="order">
					<div class="head">
                        ...
                        <a href="tambahmhs.php" type="button" class="btn btn-outline-primary">Tambah Mahasiswa +</a>
					</div>
					<table>
						<thead>
						...
						<tbody>
							...
							while ($mhs = mysqli_fetch_assoc($resultmhs)) {
								...
								echo "<td> <a style='color: var(--blue); font-size: 25px' href='editmhs.php?id=" . mysqli_real_escape_string($conn, $mhs['id']) . "'>
							 				<i class='bx bx-edit'></i></a>
							 			</td>";
								echo "<td> <a style='color: var(--red); font-size: 25px; cursor: pointer;' onclick='confirmDelete(" . mysqli_real_escape_string($conn, $mhs['nim']) . ")'>
    ...
    <script>
		...
		function confirmDelete(id) {
			...
			if (result) {
				...
				window.location.href = '../../../controller/app/admin/hapus.php?id=' + id;
			} else {
