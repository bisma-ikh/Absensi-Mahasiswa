				...
				<div class="left">
					...
					<ul >
						<li style="margin-left: -30px;">
							<a href="dosen.php" style="color: var(--dark)">Back</a>
						</li>
					</ul>
				</div>
			</div>
            <div class="table-data">
				<div class="order">
                    ...
                    <?php 
                        ...
                        if(isset($_GET['id'])){
                            $id = $_GET['id'];
                            $dosenquery = "SELECT * FROM dosen WHERE id = '$id'";
                            $dosenresult = mysqli_query($conn, $dosenquery);
                            
                            // Periksa apakah query berhasil dijalankan
                            if($dosenresult && mysqli_num_rows($dosenresult) > 0) {
                                $dosen = mysqli_fetch_assoc($dosenresult);
                            } 
                        }
                    ?>

                    <form action="../../../controller/app/admin/updatedosen.php?id=<?php echo $id ?>" method="POST">
                        <div class="mb-3 row">
                            <label class="col-sm-2 col-form-label">NIP</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control-plaintext" value="<?php echo $dosen['nip'] ?>" name="nip">
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <input type="number"  class="form-control" value="<?php echo $dosen['phone'] ?>" name="no">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-select" aria-label="Default select example" name="prodi">
                                    <option><?php echo $dosen['kode_prodi'] ?></option>
                                    <?php 
                        ...
                        <div class="mb-3-row">
                            <div class="col-sm-12 d-flex justify-content-end">
                                <a href="dosen.php" style="margin-right: 10px;" class="btn btn-outline-danger" name="batal">Batal</a>
