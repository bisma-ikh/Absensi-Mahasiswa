			...
			<div class="table-data">
				<div class="order">
					...
					<table>
						...
						<tbody>
							<?php
								// Kueri SQL untuk mengambil data absensi berdasarkan kode_jadwal
								$query = "SELECT * FROM absensi WHERE kode_jadwal";
					...
					<div class="mb-3-row">
						<div class="col-sm-12 d-flex justify-content-end">
							<a href="jadwal.php" style="margin-right: 10px;" class="btn btn-outline-danger" name="batal">Kembali</a>
							<button type="submit" class="btn btn-outline-primary" name="simpan">Selesai</button>
						</div>
					</div>
				</div>
			</div>
