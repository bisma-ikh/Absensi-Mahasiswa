...
$check_jadwal = mysqli_query($conn, "SELECT * FROM jadwal WHERE nip=$id");
...
if (mysqli_num_rows($check_jadwal) > 0) {
    ...
    if ($result && $result1) {
        ...
        echo '<script>alert("Penghapusan berhasil."); window.location.href = "../../../public/view/admin/dosen.php";</script>';
    } else {
        // If deletion fails
        echo '<script>alert("Penghapusan gagal. Silakan coba lagi."); window.location.href = "../../../public/view/admin/dosen.php";</script>';
    }
}
